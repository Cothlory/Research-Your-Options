...
export const mockQualtricsPayload = {
  values: {
    ...
    optional_notes: "Looking for students available 6-8 hrs/week.",
    desired_skills: "Python, curiosity, willingness to learn",
    last_confirmed_by_submitter: "2026-03-01",
  },
};
